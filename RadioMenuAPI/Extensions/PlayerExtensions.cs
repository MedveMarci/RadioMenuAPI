...
public static class PlayerExtensions
{
    ...
    {
        return RadioMenuManager.GiveRadioMenu(player, title);
    }
    ...
    {
        return RadioMenuManager.GiveRadioMenu(player, menu);
    }
    ...
    {
        return RadioMenuManager.GetSelectedItem(player);
    }
    ...
    {
        return RadioMenuManager.GetSelectedIndex(player);
    }
    ...
    {
        return RadioMenuManager.PlayerActiveRadio.ContainsKey(player.ReferenceHub.GetInstanceID());
    }
    ...
    public static Action<MenuOpenedEventArgs> SubscribeMenuOpened(this Player player,
        Action<MenuOpenedEventArgs> handler)
    {
        Action<MenuOpenedEventArgs> filtered = ev =>
        {
            if (ev.Player == player) handler(ev);
        };
    ...
    public static Action<MenuClosedEventArgs> SubscribeMenuClosed(this Player player,
        Action<MenuClosedEventArgs> handler)
    {
        Action<MenuClosedEventArgs> filtered = ev =>
        {
            if (ev.Player == player) handler(ev);
        };
    ...
    public static Action<MenuItemChangedEventArgs> SubscribeItemChanged(this Player player,
        Action<MenuItemChangedEventArgs> handler)
    {
        Action<MenuItemChangedEventArgs> filtered = ev =>
        {
            if (ev.Player == player) handler(ev);
        };
    ...
    public static Action<MenuItemSelectedEventArgs> SubscribeItemSelected(this Player player,
        Action<MenuItemSelectedEventArgs> handler)
    {
        Action<MenuItemSelectedEventArgs> filtered = ev =>
        {
            if (ev.Player == player) handler(ev);
        };
